...
var bsInit = function (paths, openOverride) {
    ...
    apiProxy.route = '/api';
    var oauthProxy = url.parse('http://localhost:8080/oauth');
    ...
    console.log('   Map to: ' + chalk.green('http://localhost:8080/api'));
    console.log(chalk.dim(' ---------------------------------------'));
    console.log('     Path: ' + chalk.green('/oauth'));
    console.log('   Map to: ' + chalk.green('http://localhost:8080/ouath'));
    console.log(chalk.dim(' ---------------------------------------'));
