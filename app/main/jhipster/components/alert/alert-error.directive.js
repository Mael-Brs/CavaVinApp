(function() {
  ...
  function jhiAlertErrorController($scope, AlertService, $rootScope, $translate) {
    ...
    const cleanHttpErrorListener = $rootScope.$on('cavavinApp.httpError', function(event, httpResponse) {
      let i;
      ...
      switch (httpResponse.status) {
        ...
        case 400:
          ...
          if (errorHeader) {
            const entityName = $translate.instant('global.menu.entities.' + entityKey);
            ...
            for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
              ...
              const fieldName = $translate.instant('cavavinApp.' + fieldError.objectName + '.' + convertedField);
